  ...
  return (
    <div className="bg-[#0f0f0f] text-white min-h-screen">
      ...
      <section className="min-h-screen flex flex-col items-center justify-center px-8 text-center">
        ...
        {/* NAME */}
        <h1 className="text-5xl lg:text-7xl font-bold mb-6">Steve Lomax</h1>
      ...
      <section className="px-8 py-24 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-300 text-lg leading-relaxed mb-8">
            I’m an aspiring software developer focused on building clean,
            responsive, and user-friendly applications. While I’m still early in
            my career, I take pride in writing clean, detailed, and reliable
            code, and I’m always looking for opportunities to grow my skills.
          </p>
      ...
      <section className="px-8 py-24 border-t border-gray-800">
        <div className="max-w-4xl mx-auto text-center">
          ...
          <p className="text-gray-400 text-lg mb-10">
            I'm currently open to front-end development opportunities, freelance
